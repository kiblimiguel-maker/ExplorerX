import { Clock3, Compass, Flame, LocateFixed, Mountain, Sparkles, Waves } from 'lucide-react'
...
export default function DiscoverPage() {
  ...
  const sections = useMemo<DiscoverySection[]>(() => {
    ...
    return [
      ...
      { title: 'Baden', subtitle: 'Echte Badestellen aus der Community.', icon: <Waves/>, places: take(results.filter((place) => place.category === 'Baden'), 3), tone: 'near' },
