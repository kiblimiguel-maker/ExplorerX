import { Activity, Bookmark, Camera, Clock3, Crown, Flame, Footprints, Heart, MessageCircle, Sparkles, Star, TrendingUp, UsersRound, Waves } from 'lucide-react'
...
export default function TrendingPage() {
  ...
  const totalActivity = ranked.reduce((sum, place) => sum + (place.recent_likes || 0) + (place.recent_comments || 0), 0)
  ...
  return <div className="content-page trending-page trending-product-page social-product-page">
    <ProductHero
      ...
      metrics={[
        { label: 'Orte im Ranking', value: ranked.length, icon: <TrendingUp/> },
        { label: 'Community-Likes', value: ranked.reduce((sum, place) => sum + place.likes_count, 0), icon: <Heart/> },
        { label: 'Neue Aktivität', value: totalActivity, icon: <Activity/> },
        { label: 'Besuche', value: ranked.reduce((sum, place) => sum + (place.visits_count || 0), 0), icon: <Footprints/> },
      ]}
    />
