...
const categoryColors: Record<string, string> = { Sport: '#49d17d', Baden: '#1488ff', Natur: '#79d15a', Aussicht: '#a66cff', Essen: '#ffb54b', Treffpunkt: '#ff6d5a', Abenteuer: '#12c7af', Sonstiges: '#95a2b3' }
...
function ClusteredMarkers({ places, onSelect, favoriteIds, trendingIds, selectedId }: { places: Place[]; onSelect?: (place: Place) => void; favoriteIds: Set<string>; trendingIds: Set<string>; selectedId?: string }) {
  ...
  const { favoriteIds: accountFavoriteIds, friendVisitCounts, toggleFavorite, visitedIds } = useSocial()
